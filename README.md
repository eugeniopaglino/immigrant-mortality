...
(ASCDR) were then computed for all causes combined, COVID-19, and all
...
categories to US-born and foreign-born difference in ASCDRs at ages 25+
...
is the repository structure.
    ...
    ## │   ├── relDiffTrendsSimpleHPlot.pdf
    ## │   ├── sampleTableFemales.png
    ## │   ├── sampleTableMales.png
    ## │   ├── summaryTableFemales.png
    ## │   ├── summaryTableMales.png
    ## │   ├── USBornForeignDiffFemalesColorSafePlot.pdf
    ## │   └── USBornForeignDiffMalesColorSafePlot.pdf
    ## ├── R
    ## │   ├── contributionsPlots.Rmd
    ## │   ├── createComorbTable.Rmd
    ## │   ├── createFinalTable - Copy.Rmd
...
<td style="text-align:left;">
Standard deviation of the ASCDR computed using the formula in Chiang
...
<td style="text-align:left;">
Coefficient of variation for the ASCDR computed as ASCDR.SD/ASCDR.
</td>
<td style="text-align:left;">
Num: 0.027 to 3.753
</td>
